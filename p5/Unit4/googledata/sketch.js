...
function setup() {
  ...
  let url = '1Hs50yH1_n4f03Y5mMC0cVBauW0I6a8QvYOkEmGLG-zE';
  let settings = {
...
function gotData(data) {
  ...
  for (let i = 0; i < data.length; i++) {
    bubbles.push(new Bubble(data[i].Name, data[i].Birthday, data[i].Zodiac)); // THESE Name and Shape need to match your column names in your spreadsheet!
  }
...
class Bubble {
  ...
  constructor(myName, myBirthday, myZodiac) {
    this.name = myName;
    this.birthday = myBirthday;
    this.zodiac = myZodiac;
